...
namespace Rage {
	...
	struct CEvent_vftable;

	struct CEvent {
		CEvent_vftable* vftable;
	};

	struct CEvent_vftable {
		void (*dtor)(CEvent*);
		CEvent* (*Clone)(CEvent*);
		bool (*Equals)(CEvent*, CEvent*);
		int32_t(*GetID)(CEvent*);
		int32_t(*GetPriority)(CEvent*);
	};

	enum class CEventID : int16_t
	{
		CEventAcquaintancePedDead = 5,
		CEventAcquaintancePedDislike = 0,
		CEventAcquaintancePedHate = 1,
		CEventAcquaintancePedLike = 2,
		CEventAcquaintancePedWanted = 4,
		CEventAgitated = 6,
		CEventAgitatedAction = 7,
		CEventCallForCover = 9,
		CEventCarUndriveable = 10,
		CEventClimbLadderOnRoute = 11,
		CEventClimbNavMeshOnRoute = 12,
		CEventCombatTaunt = 13,
		CEventCommunicateEvent = 14,
		CEventCopCarBeingStolen = 15,
		CEventCrimeCryForHelp = 32,
		CEventCrimeReported = 16,
		CEventDamage = 17,
		CEventDeadPedFound = 18,
		CEventDeath = 19,
		CEventDisturbance = 140,
		CEventDraggedOutCar = 20,
		CEventEncroachingPed = 8,
		CEventEntityDamaged = 141,
		CEventEntityDestroyed = 142,
		CEventErrorArrayOverflow = 241,
		CEventErrorInstructionLimit = 242,
		CEventErrorStackOverflow = 243,
		CEventErrorUnknownError = 240,
		CEventExplosion = 22,
		CEventExplosionHeard = 23,
		CEventFireNearby = 24,
		CEventFootStepHeard = 26,
		CEventFriendlyAimedAt = 127,
		CEventFriendlyFireNearMiss = 128,
		CEventGetOutOfWater = 27,
		CEventGivePedTask = 28,
		CEventGunAimedAt = 29,
		CEventGunShot = 124,
		CEventGunShotBulletImpact = 125,
		CEventGunShotWhizzedBy = 126,
		CEventHelpAmbientFriend = 30,
		CEventHurtTransition = 144,
		CEventInAir = 33,
		CEventIncapacitated = 35,
		CEventInjuredCryForHelp = 31,
		CEventLeaderEnteredCarAsDriver = 36,
		CEventLeaderExitedCarAsDriver = 38,
		CEventLeaderHolsteredWeapon = 39,
		CEventLeaderLeftCover = 40,
		CEventLeaderUnholsteredWeapon = 41,
		CEventMeleeAction = 42,
		CEventMustLeaveBoat = 43,
		CEventNewTask = 44,
		CEventObjectCollision = 46,
		CEventOnFire = 47,
		CEventOpenDoor = 48,
		CEventPedCollisionWithPed = 50,
		CEventPedCollisionWithPlayer = 51,
		CEventPedEnteredMyVehicle = 52,
		CEventPedJackingMyVehicle = 53,
		CEventPedOnCarRoof = 54,
		CEventPedSeenDeadPed = 149,
		CEventPlayerCollisionWithPed = 57,
		CEventPlayerDeath = 148,
		CEventPlayerUnableToEnterVehicle = 145,
		CEventPotentialBeWalkedInto = 59,
		CEventPotentialBlast = 60,
		CEventPotentialGetRunOver = 61,
		CEventPotentialWalkIntoVehicle = 64,
		CEventProvidingCover = 65,
		CEventRanOverPed = 67,
		CEventReactionEnemyPed = 69,
		CEventReactionInvestigateDeadPed = 70,
		CEventReactionInvestigateThreat = 71,
		CEventRequestHelpWithConfrontation = 72,
		CEventRespondedToThreat = 73,
		CEventScenarioForceAction = 146,
		CEventScriptCommand = 75,
		CEventShockingBicycleCrash = 80,
		CEventShockingBicycleOnPavement = 86,
		CEventShockingBrokenGlass = 76,
		CEventShockingCarAlarm = 77,
		CEventShockingCarChase = 78,
		CEventShockingCarCrash = 79,
		CEventShockingCarOnCar = 82,
		CEventShockingCarPileUp = 81,
		CEventShockingDangerousAnimal = 83,
		CEventShockingDeadBody = 84,
		CEventShockingDrivingOnPavement = 85,
		CEventShockingEngineRevved = 87,
		CEventShockingExplosion = 88,
		CEventShockingFire = 89,
		CEventShockingGunFight = 90,
		CEventShockingGunshotFired = 91,
		CEventShockingHelicopterOverhead = 92,
		CEventShockingHornSounded = 95,
		CEventShockingInDangerousVehicle = 96,
		CEventShockingInjuredPed = 97,
		CEventShockingMadDriver = 98,
		CEventShockingMadDriverBicycle = 100,
		CEventShockingMadDriverExtreme = 99,
		CEventShockingMugging = 101,
		CEventShockingNonViolentWeaponAimedAt = 102,
		CEventShockingParachuterOverhead = 93,
		CEventShockingPedKnockedIntoByPlayer = 94,
		CEventShockingPedRunOver = 103,
		CEventShockingPedShot = 104,
		CEventShockingPlaneFlyby = 105,
		CEventShockingPotentialBlast = 106,
		CEventShockingPropertyDamage = 107,
		CEventShockingRunningPed = 108,
		CEventShockingRunningStampede = 109,
		CEventShockingSeenCarStolen = 110,
		CEventShockingSeenConfrontation = 111,
		CEventShockingSeenGangFight = 112,
		CEventShockingSeenInsult = 113,
		CEventShockingSeenMeleeAction = 114,
		CEventShockingSeenNiceCar = 115,
		CEventShockingSeenPedKilled = 116,
		CEventShockingSiren = 121,
		CEventShockingStudioBomb = 122,
		CEventShockingVehicleTowed = 117,
		CEventShockingVisibleWeapon = 123,
		CEventShockingWeaponThreat = 118,
		CEventShockingWeirdPed = 119,
		CEventShockingWeirdPedApproaching = 120,
		CEventShoutBlockingLos = 129,
		CEventShoutTargetPosition = 130,
		CEventShovePed = 49,
		CEventStatChangedValue = 147,
		CEventStaticCountReachedMax = 131,
		CEventStuckInAir = 132,
		CEventSuspiciousActivity = 133,
		CEventSwitch2NM = 134,
		CEventUnidentifiedPed = 135,
		CEventVehicleCollision = 136,
		CEventVehicleDamageWeapon = 137,
		CEventVehicleOnFire = 138,
		CEventWrithe = 143
	};
}